...
const WALKTHROUGH_STEPS: WalkthroughStep[] = [
    {
        ...
        description: 'Tap this button to begin capturing audio. The app will listen for claims and automatically verify them.',
        cardPosition: 'center-bottom'
    },
    {
        targetSelector: '.source-button',
        title: 'Choose Your Source',
        description: 'Cycle through input modes: Screen audio, Microphone, Both, or None. Pick what works best for your situation.',
        cardPosition: 'center-bottom'
    },
    {
        targetSelector: '.card-list-container',
        title: 'Your Claims',
        description: 'Detected claims appear here as cards. Each card shows the claim text, verification status, and sources.',
        cardPosition: 'upper-center'
    },
    {
        targetSelector: '.menu-button',
        title: 'Switch Themes',
        description: 'Toggle between light and dark mode. The app also follows your system preferences automatically.',
        cardPosition: 'upper-center'
    }
]
...
export function Walkthrough({ isOpen, onClose }: WalkthroughProps): React.JSX.Element | null {
    ...
    const positionClass = step.cardPosition === 'center-bottom'
        ? 'walkthrough-card-bottom'
        : 'walkthrough-card-top'
            ...
            <div className={`walkthrough-card ${positionClass}`}>
                ...
                <div className="walkthrough-nav">
                    ...
                    <div className="walkthrough-nav-main">
                        {currentStep > 0 && (
                            <button
                                className="walkthrough-btn walkthrough-btn-back"
                                onClick={handleBack}
                            >
                                Back
                            </button>
